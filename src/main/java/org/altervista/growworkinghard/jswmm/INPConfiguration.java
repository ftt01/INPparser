 ...
 * @version 0.1
 */
public class INPConfiguration extends BaseHierarchicalConfiguration implements
        FileBasedConfiguration
{
     ...
     */
    public INPConfiguration()
    {
        super();
    }

    /**
     * Creates a new instance of {@code INPConfiguration} with the
     * content of the specified {@code HierarchicalConfiguration}.
     *
     * @param c the configuration to be copied
     */
    public INPConfiguration(HierarchicalConfiguration<ImmutableNode> c)
    {
        super(c);
    }

    /**
     * Get separator used in INP output
     *
     * @return the current separator for writing the INP output
     */
     ...
     * of the resulting INP output
     *
     * @param separator String of the new separator for INP output
     */
     ...
     * to the storage scheme used by {@code INPConfiguration}.
    ...
    /**
     * Creates a sub configuration for the global section of the represented INP
     * configuration.
     *
